        ...
        <View className="mt-6 space-y-4">
          <Controller
            ...
            render={({ field: { onChange, onBlur, value } }) => (
              <TextInput
                className="h-12 border border-[#2d114510] rounded-[5px] px-3 font-[roboto]"
          ...
          <Controller
            ...
            render={({ field: { onChange, value } }) => (
              <TouchableOpacity
                className="h-12 border border-[#2d114510] rounded-[5px] px-3 justify-center"
                onPress={() => setShowDatePicker(true)}
              >
                <Text className="font-[roboto] text-grey">
